...
@Component({
  ...
  template: `
    <div class="max-w-lg mx-auto bg-base-100 shadow-xl rounded-box p-6">
      <h2 class="text-2xl font-bold mb-6">Dodaj rolę</h2>
      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()">
        <div class="form-control w-full mb-4">
          ...
          <input type="text" formControlName="name" class="input input-bordered w-full"
                 [class.input-error]="isInvalid('name')" placeholder="np. MANAGER"/>
        ...
        <div class="flex justify-end gap-4">
          <a routerLink="/admin/roles" class="btn btn-ghost">Anuluj</a>
