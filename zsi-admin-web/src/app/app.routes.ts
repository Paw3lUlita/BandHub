...
export const routes: Routes = [
  ...
  // 2. Ścieżka chroniona /admin
  {
    ...
    children: [
      ...
      { path: 'payments/new', loadComponent: () => import('./features/ecommerce/payments/payment-form.component').then(m => m.PaymentFormComponent) },
      { path: 'payments/:id', loadComponent: () => import('./features/ecommerce/payments/payment-form.component').then(m => m.PaymentFormComponent) },
      ...
      { path: 'shipments/new', loadComponent: () => import('./features/ecommerce/shipments/shipment-form.component').then(m => m.ShipmentFormComponent) },
      { path: 'shipments/:id', loadComponent: () => import('./features/ecommerce/shipments/shipment-form.component').then(m => m.ShipmentFormComponent) },
      ...
      { path: 'setlists/new', loadComponent: () => import('./features/fan/setlists/setlist-add.component').then(m => m.SetlistAddComponent) },
      { path: 'setlists/:id', loadComponent: () => import('./features/fan/setlists/setlist-add.component').then(m => m.SetlistAddComponent) },
      ...
      { path: 'tour-legs/new', loadComponent: () => import('./features/logistics/tour-legs/tour-leg-form.component').then(m => m.TourLegFormComponent) },
      { path: 'tour-legs/:id', loadComponent: () => import('./features/logistics/tour-legs/tour-leg-form.component').then(m => m.TourLegFormComponent) },
      ...
      { path: 'tour-settlements/new', loadComponent: () => import('./features/logistics/tour-settlements/tour-settlement-close.component').then(m => m.TourSettlementCloseComponent) },
      { path: 'tour-settlements/:id', loadComponent: () => import('./features/logistics/tour-settlements/tour-settlement-detail.component').then(m => m.TourSettlementDetailComponent) },
